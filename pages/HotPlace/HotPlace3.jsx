...
const HotPlace3 = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      ><Text style={{fontWeight:"bold", fontSize:17}}>이름을 입력해주세요.</Text> 
     ...
     <View
      ...
      <View style={{position:"absolute",bottom:30, width:"100%", padding:5}}>
        <TouchableOpacity onPress={() => navigation.navigate("HotPlace4")}>
