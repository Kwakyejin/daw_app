...
const hideDatePicker3 = () => {
  ...
  return (
    ...
    >
      ...
      ><Text style={{fontWeight:"bold", fontSize:17, marginLeft:10}}>행사기간을 알려주세요</Text> 
      <View style={{marginTop:5}}>
      <View style={{flexDirection:"row"}}>
            <Button title="행사 시작일" onPress={showDatePicker} /><TextInput
                    pointerEvents="none"
        ...
        <View style={{flexDirection:"row"}}>
            <Button title="행사 마감일" onPress={showDatePicker2} />
            <TextInput
                    pointerEvents="none"
                    style={{ fontSize:15, fontWeight:"bold", color:"#000000"}}
                    placeholderTextColor='#000000'
      ...
      <View style={{position:"absolute",bottom:30, width:"100%", padding:5}}>
        ...
        <TouchableOpacity  onPress={() => navigation.navigate("HotPlace1")}>
